...
/** Add remove Diacritics (remove acentos) to String prototype */
String.prototype.defaultDiacriticsRemovalMap = [
...
String.prototype.removeDiacritics = function() {
  var copy = this;
    ...
    for(var i=0; i< this.defaultDiacriticsRemovalMap.length; i++) {
        copy = copy.replace(this.defaultDiacriticsRemovalMap[i].letters, this.defaultDiacriticsRemovalMap[i].base);
    }
    return copy;
};
var Nextt = Nextt || {};
